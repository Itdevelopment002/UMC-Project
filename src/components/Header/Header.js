        ...
        <div className="nav-menu d-flex justify-content-between align-items-center">
          ...
          <nav
            className={`custom-nav ${
              isNavCollapsed ? "nav-hidden" : "nav-visible"
            }`}
          >
            <ul className="nav-list mb-0 px-4">
              ...
              <li
                className={`nav-item ${
                  activeLink === "Administrative Wings" ? "active" : ""
                }`}
              >
                <Link
                  to="#."
              ...
              <li
                className={`nav-item ${
                  activeLink === "Online Services" ? "active" : ""
                }`}
              >
                <Link
                  to="#."
              ...
              <li
                className={`nav-item ${
                  activeLink === "RTS Act 2015" ? "active" : ""
                }`}
              >
                <Link
                  to="#."
